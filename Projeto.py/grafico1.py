...
# Dados de reclamações por banco (os mesmos dados fornecidos anteriormente)
dados = [
...
fig.add_trace(go.Bar(
    ...
    marker=dict(
        ...
        line=dict(color='rgba(64, 224, 208, 1)', width=1.5)
    ),
    text=reclamacoes,
...
fig.update_layout(
    title="Total de Reclamações por Banco",
